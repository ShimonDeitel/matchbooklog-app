import XCTest
@testable import MatchbookLog

@MainActor
final class MatchbookLogTests: XCTestCase {
    ...
    func testUpdateReplacesItem() {
        ...
        first.venueName = "Updated Name"
        store.update(first)
        XCTAssertEqual(store.items.first?.venueName, "Updated Name")
    }
